...
?>
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            <li  class="active"><a href="#"  onclick="redirectTo('<?=$curModule->app_url();?>start/allui')" >ALL UI Element</a></li>
            <li ><a href="#" onclick="redirectTo('<?=$curModule->app_url();?>start/gaeui')">GAEUI Component</a></li>
        </ul> <!-- /tabs -->
      </div>
    </div> <!-- /row -->
    ...
    <div class="container">
      ...
      <div class="demo-row demo-buttons">
        <div class="demo-title">
          <h3 class="demo-panel-title">GAE Button</h3>
        </div>
        <div class="demo-col">
          <a href="#fakelink" class="btn btn-sm btn-block btn-primary btn-gae-manager">Done</a>
          <a href="#fakelink" class="btn btn-sm btn-block btn-primary btn-gae-manager">Yes</a>
          <a href="#fakelink" class="btn btn-sm btn-block btn-default btn-gae-manager">Cancel</a>
          <a href="#fakelink" class="btn btn-sm btn-block btn-save btn-gae-manager">save</a>

          <div style="background-color: #333; padding:20px; height: 80px;" >
            <a href="#fakelink" class="btn btn-sm btn-block btn-cancel_tran btn-gae-manager">cancel</a>
          </div>
      ...
      <div class="demo-row demo-buttons">
        ...
        <div class="demo-col">
          <a href="#fakelink" class="btn btn-lg btn-block btn-ori-primary">Ori Primary Button</a>
      ...
      <div class="demo-row demo-buttons">
        <div class="demo-title">
          <h3 class="demo-panel-title">Button States + radius</h3>
        </div>

        <div class="demo-col">
          <a href="#fakelink" class="btn btn-lg btn-block btn-ori-primary btn-gae-radius">Gae Radius Button</a>
          <a href="#fakelink" class="btn btn-lg btn-block btn-primary btn-gae-radius">Primary Button</a>
          <a href="#fakelink" class="btn btn-lg btn-block btn-warning btn-gae-radius">Warning Button</a>
          <a href="#fakelink" class="btn btn-lg btn-block btn-default btn-gae-radius">Default Button</a>
          <a href="#fakelink" class="btn btn-lg btn-block btn-danger btn-gae-radius">Danger Button</a>
        </div>

        <div class="demo-col">
          <a href="#fakelink" class="btn btn-lg btn-block btn-success btn-gae-radius">Success Button</a>
          <a href="#fakelink" class="btn btn-lg btn-block btn-inverse btn-gae-radius">Inverse Button</a>
          <a href="#fakelink" class="btn btn-lg btn-block btn-info btn-gae-radius">Info Button</a>
          <a href="#fakelink" class="btn btn-lg btn-block disabled btn-gae-radius">Disabled Button</a>
        </div>
      </div> <!-- /row -->
      ...
      <div class="demo-row demo-buttons">
        <div class="demo-title">
          <h3 class="demo-panel-title">Button Variants + radius</h3>
        </div>

        <div class="demo-content">
          <a href="#fakelink" class="btn btn-hg btn-primary btn-gae-radius"><span class="fui-twitter"></span>&nbsp;&nbsp;It's a</a>
          <a href="#fakelink" class="btn btn-hg btn-primary btn-gae-radius mhm">Huge</a>
          <a href="#fakelink" class="btn btn-hg btn-primary">Button</a>
          <a href="#fakelink" class="btn btn-hg btn-primary btn-gae-radius mlm"><span class="fui-check-circle"></span></a>
          <a href="#fakelink" class="btn btn-hg btn-primary btn-gae-radius btn-embossed mlm">Embossed</a>
          <a href="#fakelink" class="btn btn-hg btn-primary btn-gae-radius btn-block">Huge Fluid Button<span class="fui-arrow-right pull-right"></span></a>

          <a href="#fakelink" class="btn btn-lg btn-primary btn-gae-radius"><span class="fui-twitter"></span>&nbsp;&nbsp;It's a</a>
          <a href="#fakelink" class="btn btn-lg btn-primary btn-gae-radius mhm">Large</a>
          <a href="#fakelink" class="btn btn-lg btn-primary btn-gae-radius">Button</a>
          <a href="#fakelink" class="btn btn-lg btn-primary btn-gae-radius mlm"><span class="fui-check-circle"></span></a>
          <a href="#fakelink" class="btn btn-lg btn-primary btn-gae-radius btn-embossed mlm">Embossed</a>
          <a href="#fakelink" class="btn btn-lg btn-primary btn-gae-radius btn-block">Large Fluid Button <span class="fui-arrow-right pull-right"></span></a>
          <a href="#fakelink" class="btn btn-primary btn-gae-radius"><span class="fui-twitter"></span> It's a</a>
          <a href="#fakelink" class="btn btn-primary btn-gae-radius mhm">Standard</a>
          <a href="#fakelink" class="btn btn-primary btn-gae-radius">Button</a>
          <a href="#fakelink" class="btn btn-primary btn-gae-radius mlm"><span class="fui-check-circle"></span></a>
          <a href="#fakelink" class="btn btn-primary btn-gae-radius btn-embossed mlm">Embossed</a>
          <a href="#fakelink" class="btn btn-primary btn-gae-radius btn-block">Standard Fluid Button <span class="fui-arrow-right pull-right"></span></a>

          <a href="#fakelink" class="btn btn-sm btn-primary btn-gae-radius"><span class="fui-twitter"></span>&nbsp;&nbsp;It's a</a>
          <a href="#fakelink" class="btn btn-sm btn-primary btn-gae-radius mhm">Small</a>
          <a href="#fakelink" class="btn btn-sm btn-primary btn-gae-radius">Button</a>
          <a href="#fakelink" class="btn btn-sm btn-primary btn-gae-radius mlm"><span class="fui-check-circle"></span></a>
          <a href="#fakelink" class="btn btn-sm btn-primary btn-gae-radius btn-embossed mlm">Embossed</a>
          <a href="#fakelink" class="btn btn-sm btn-primary btn-gae-radius btn-block">Small Fluid Button <span class="fui-arrow-right pull-right"></span></a>

          <a href="#fakelink" class="btn btn-xs btn-primary btn-gae-radius"><span class="fui-twitter"></span>&nbsp;&nbsp;It's a</a>
          <a href="#fakelink" class="btn btn-xs btn-primary btn-gae-radius mhm">Mini</a>
          <a href="#fakelink" class="btn btn-xs btn-primary btn-gae-radius">Button</a>
          <a href="#fakelink" class="btn btn-xs btn-primary btn-gae-radius mlm"><span class="fui-check-circle"></span></a>
          <a href="#fakelink" class="btn btn-xs btn-primary btn-gae-radius btn-embossed mlm">Embossed</a>
          <a href="#fakelink" class="btn btn-xs btn-primary btn-gae-radius btn-block">Mini Fluid Button <span class="fui-arrow-right pull-right"></span></a>
        </div>
      </div> <!-- /row -->
      ...
      <div class="demo-row">
        ...
        <div class="demo-content">
          <div class="demo-inline demo-labels">
            ...
            <span class="label label-ori-primary">Ori Primary</span>
      ...
      <div class="demo-row">
        ...
        <div class="demo-content">
          <ul class="breadcrumb">
            <li><a href="#fakelink" class="text-gae-primary">Home</a></li>
    ...
    <div class="container ptl">
      <div class="demo-row typography-row">
        ...
        <div class="demo-content">
          ...
          <div class="demo-type-example">
            ...
            <img src="<?=$docs_dir_url; ?>assets/img/exaple-image.jpg" alt="exaple-image" class="img-rounded img-responsive">
          ...
          <div id="myCarousel" class="carousel slide" data-interval="false">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <img src="<?=root_sitefiles_url(); ?>flat-ui/UI/pro/docs/assets/img/carousel/image-01.jpg" alt="" />
              ...
              <div class="item">
                <img src="<?=root_sitefiles_url(); ?>flat-ui/UI/pro/docs/assets/img/carousel/image-02.jpg" alt="" />
                <div class="carousel-caption">
                  <h3>Thumbnail label</h3>
                  <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec.</p>
                </div>
              ...
              <div class="item">
                <img src="<?=root_sitefiles_url(); ?>flat-ui/UI/pro/docs/assets/img/carousel/image-03.jpg" alt="" />
                <div class="carousel-caption">
                  <h3>Thumbnail label</h3>
                  <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec.</p>
                </div>
      ...
      <div class="demo-row demo-video">
        ...
        <div class="demo-content-wide">
          <video class="video-js" preload="auto" poster="<?=$docs_dir_url; ?>assets/img/video/poster.jpg" data-setup="{}">
      ...
      <div class="demo-row demo-illustrations">
        ...
        <? 
        	...
        	foreach ($svs_files as $key => $row){
        		...
        		?>
        		 <div><img src="<?=$svg_file_url; ?>" alt="" /></div>
...
<script src="<?=root_sitefiles_url(); ?>flat-ui/UI/pro/docs/assets/js/prettify.js"></script>
