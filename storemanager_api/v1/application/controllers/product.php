...
class product extends base_controller {
    ...
    public function getarrayimage($product_id=2)
    {
    ...
    public function saveimagearray($product_id="",$image_id_array=array())
    {
        ...
        $image_id_array = array(array("image_id"=>28),array("image_id"=>29));
    ...
    public function deleteimagearray($product_id=2,$image_id_array=array())
    {

        $image_id_array = array(array("image_id"=>28));
    ...
    public function add_pdf(){
      ...
      $uploadFileData = $this->root_file_model->upload("file_pdf",1);

      $successFiles = $uploadFileData["successFiles"];

      foreach ( $successFiles as $index => $value) {
          $this->root_product_model->addPDF($product_id,$value["file_id"]);        
      }
    ...
    public function get_pdf($product_id = 2){

        $this->load->model("root_product_model");
        $file_array = $this->root_product_model->getPDFArray($product_id,5);
        resOk($file_array);
    }

    public function delete_pdf($product_id = 2){

        $file_id_array = array(array("file_id"=>547));
        $this->load->model("root_product_model");
        $result = $this->root_product_model->deletePDFArray($product_id,$file_id_array);
        resOk($result);
    }
