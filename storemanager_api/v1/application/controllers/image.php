...
class image extends base_controller {
    ...
    public function  lists(){
        ...
        if(intval($imagegallery_id)==0){
            ...
            $whereStr = " image.imagegallery_id = ? ";
        ...
        $data_list_ar = $this->root_image_model->getLists($whereStr,$paramAr,$cur_page,$per_page,$sortby_id);
    ...
    public function  search(){
        ...
        $whereStr = " image.imagegallery_id = ? AND image.title LIKE ? ";
    ...
    public function  upload(){
        ...
        if(sizeof($uploadData["successFiles"])>0){
            ...
            if($crop_json!=""){
                $resultCrop = $this->root_image_model->cropRectImageById($image_id,$cropData);
                $uploadData["resultCrop"] = $resultCrop;
            }
            if(is_numeric($rotate_degree)){
