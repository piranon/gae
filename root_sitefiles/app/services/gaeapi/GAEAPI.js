 ...
 var GAEAPI_CLASS = function(){

     var GAEAPI_OBJ = {
            get:function(apiCallName,dataArray){
                var self = this;
                var apiUrl = GURL.base_api_url()+apiCallName;
                return self.ajax().get(apiUrl,dataArray);
            },
            post:function(apiCallName,dataArray){
                var self = this;
                var apiUrl = GURL.base_api_url()+apiCallName;
